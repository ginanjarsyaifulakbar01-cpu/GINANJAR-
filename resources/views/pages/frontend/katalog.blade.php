...
@section('content')
    <style>
        ...
        .book-cover-wrapper {
            width: 100%;
            height: 300px;
            /* Tinggi proporsional buku */
            border-radius: 18px;
            overflow: hidden;
            margin-bottom: 15px;
            background: #f8fafc;
            /* Background buat sela-sela cover */
            display: flex;
            align-items: center;
        ...
        .book-cover {
            ...
            max-height: 100%;
            object-fit: contain;
            /* Kunci agar cover terlihat full */
            border-radius: 8px;
        ...
        <div class="catalog-wrapper">
            ...
            <div class="main-catalog">
                ...
                <div class="grid-buku">
                    ...
                    @empty
                        <div
                            style="grid-column: 1/-1; text-align: center; padding: 100px 0; background: white; border-radius: 30px;">
                            <img src="https://illustrations.popsy.co/gray/opening-a-window.svg"
