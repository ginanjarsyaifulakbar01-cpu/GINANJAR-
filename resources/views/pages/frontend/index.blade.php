...
@section('content')
    ...
    <div class="hero">
        <div class="container">
            <div
                style="background: #dbeafe; color: #1e40af; padding: 6px 16px; border-radius: 30px; display: inline-flex; align-items: center; gap: 8px; font-size: 13px; font-weight: 700; margin-bottom: 25px;">
    ...
    <div class="container catalog-container">
        <div class="section-title">
            <h2>Buku Populer</h2>
            <a href="{{ route('katalog') }}" style="color: #2563eb; font-weight: 700; text-decoration: none;">Lihat Semua
                →</a>
        </div>
...
@php
                                $imagePath = 'https://placehold.co/300x400/64748b/ffffff?text=No+Cover';
                                if ($buku->cover) {
...
onerror="this.onerror=null;this.src='https://placehold.co/300x400/64748b/ffffff?text=Error';">
                        </div>
            ...
            @empty
                <div
                    style="grid-column: 1/-1; text-align: center; padding: 100px 0; background: white; border-radius: 30px; border: 2px dashed #e2e8f0;">
