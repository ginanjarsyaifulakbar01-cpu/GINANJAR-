        ...
        <div class="detail-wrapper">
            ...
            <div class="detail-cover-wrapper">
                <div class="detail-img-container">
                    @php
                        $cover = $pinjam->buku->cover;
                        if (!$cover) {
                            $imagePath = 'https://via.placeholder.com/400x600?text=No+Cover';
                        } elseif (Str::startsWith($cover, 'cover-img')) {
                            $imagePath = asset($cover);
                        } elseif (Str::startsWith($cover, 'storage/')) {
                            $imagePath = asset($cover);
                        } else {
                            $imagePath = asset('storage/' . $cover);
                        }
                    @endphp
                    <img src="{{ $imagePath }}" 
                         class="detail-img" 
                         alt="{{ $pinjam->buku->judul }}"
                         onerror="this.onerror=null;this.src='https://via.placeholder.com/400x600?text=Gambar+Tidak+Ditemukan';">
                </div>
