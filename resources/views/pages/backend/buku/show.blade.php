    ...
    <div class="table-card" style="padding: 30px; border-radius: 20px;">
        <div style="display: flex; gap: 40px; flex-wrap: wrap;">
            ...
            <div style="flex: 0 0 250px;">
                <img src="{{ asset($buku->cover) }}" style="width: 100%; border-radius: 15px; box-shadow: 0 10px 25px rgba(0,0,0,0.1);">
                <div style="margin-top: 20px; text-align: center; background: #f0eeff; padding: 15px; border-radius: 12px;">
                    <span style="display: block; font-size: 12px; color: #7c3aff; font-weight: 700;">TOTAL DIPINJAM</span>
                    <h3 style="margin: 5px 0 0; color: #1e1b3a; font-weight: 800;">{{ $buku->peminjaman_count }} Kali</h3>
                </div>
            </div>
            ...
            <div style="flex: 1;">
                ...
                <div style="margin-top: 30px;">
                    <a href="{{ route('admin.dashboard') }}" class="page-btn" style="text-decoration: none; background: #eee; color: #333;">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge" style="background: {{ $p->status == 'pinjam' ? '#fff4e5' : '#e6fffa' }}; color: {{ $p->status == 'pinjam' ? '#ff9800' : '#38b2ac' }}; padding: 4px 10px; border-radius: 6px; font-size: 11px;">
                                {{ strtoupper($p->status) }}
                            </span>
                        </td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="4" style="text-align: center; color: #94a3b8; padding: 20px;">Belum ada riwayat peminjaman untuk buku ini.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
